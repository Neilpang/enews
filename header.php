...
<div id="top-navigation">
  <div class="container">
    ...
    <?php $qq_close = get_option('qq_close'); if ($qq_close == 'open') {?><li><a href="<?php echo get_option('socialqq') ?>" rel="nofollow" data-placement="bottom" data-original-title="点击跟我联系吧"><img src="<?php bloginfo('template_directory'); ?>/images/qqmini.png" alt="腾讯QQ"></a></li><?php } ?>
      ...
      <?php $wechat_close = get_option('wechat_close'); if ($wechat_close == 'open') {?><li><a href="javascript:;" id="example_bottom" rel="popover nofollow" data-content="&lt;h3&gt;关注&quot;<?php echo get_option('wechat') ?>&quot;&lt;/h3&gt;&lt;img src='<?php echo get_option('wechat_qr') ?>'&gt;"><img src="<?php bloginfo('template_directory'); ?>/images/weixinmini.png" alt="微信二维码"></a></li><?php } ?>
    </ul>
  </div>
</div>
<div class="container">

  ...
  <div id="main" class="span8 single single-post image-preloader">
	...
	?>
      ...
      <div class="prevnext-posts clearfix"> <span class="prev">
        <?php if (get_previous_post()) { previous_post_link('<p>上一篇：</p> %link');} else {echo "<p>没有了</p>已经是最后文章";} ?>
        </span> <span class="next">
        <?php if (get_next_post()) { next_post_link('<p>下一篇：</p> %link');} else {echo "<p>没有了</p>已经是最新文章";} ?>
        </span> </div>
